...
image bg protagonist house =im.Scale("bg protagonist house.jpg", 1920, 1080)
image keys = im.Scale("keys.png", 200, 200)
image phone = im.Scale("phone.png", 364,417)
image cat_1 = im.Scale("cat 1.png", 300, 300)
image cat_2 = im.Scale("cat 2.png", 300, 300)
image cat_3 = im.Scale("cat 3.png", 300, 300)
image cat 4 = im.Scale("cat 4.png", 300, 300)
image shoebox_unhover = im.Scale("shoebox unhover.png", 400, 400)
